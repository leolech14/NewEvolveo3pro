...
class MetricsCollector:
    ...
    def record_extraction(
        ...
        self.transactions_extracted.labels(
            extractor=extractor_name
        ).inc(len(result.transactions))
    ...
    def record_fallback(
        self,
        from_extractor: ExtractorType,
        to_extractor: ExtractorType
    ) -> None:
        ...
        self.fallback_triggered.labels(
            from_extractor=from_extractor.value,
            to_extractor=to_extractor.value
        ).inc()
    ...
    def export_metrics(self, gateway_url: Optional[str] = None, job_name: str = 'newevolveo3pro') -> None:
...
class CostGuard:
    ...
    def check_budget_before_ocr(
        ...
        return True, f"OCR approved: ${estimated_cost:.3f} (daily total: ${projected_cost:.2f})"
